        ...
        <div className="mx-auto max-w-2xl">
            ...
            {isSubmitting ?
                (
                    ...
                    <label htmlFor="hidden-input" className="cursor-pointer mx-auto max-w-screen-lg h-full">
                        <div
                        ...
                        >
                            ...
                            }} id="hidden-input" accept="application/pdf" type="file" multiple={false} className="hidden" />
                        </div>
